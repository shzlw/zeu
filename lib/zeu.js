...
function () {
  function BaseComponent(canvas, options, viewX, viewY, viewWidth, viewHeight) {
    ...
    this._scaleX = 1;
    this._scaleY = 1; // The width and height used to draw the component.

    this._viewWidth = viewWidth !== null ? viewWidth : canvas.width;
    this._viewHeight = viewHeight !== null ? viewHeight : canvas.height; // Current X value (Left 0 to right)

    this._x = viewX; // Current Y value (Top 0 to bottom)

    this._y = viewY; // Acutal width and height of the component based on scales.
...
function (_BaseCanvas) {
  ...
  function DoubleCircle(baseDiv, options) {
    ...
    _this = _possibleConstructorReturn(this, (DoubleCircle.__proto__ || Object.getPrototypeOf(DoubleCircle)).call(this, baseDiv, 200, 200)); // TODO: pass in width, height for canvas.
    // circle color [] 4 color
    // Options

    var outer = _utility.default.has(options, 'circle') ? options.outer : null;
    ...
    _this._innerRadius = _utility.default.has(inner, 'radius') ? inner.radius : 70;
    _this._fontColor = _utility.default.has(options, 'fontColor') ? options.fontColor : _color.COLOR.green;
    _this._text = _utility.default.has(options, 'text') ? options.text : 'ABCD';
  ...
  _createClass(DoubleCircle, [{
    key: "drawFrame",
    value: function drawFrame() {
      this._degree = _utility.default.getNextAngleByDegree(this._degree, this._outerSpeed);
      ...
      this._ctx.rotate(-clockWiseAngle); // Draw round dot circle 3.
...
function (_BaseComponent) {
  ...
  _createClass(SpeedCircle, [{
    ...
    value: function setOptions(options) {
      ...
      this._color1 = _utility.default.has(options, 'color1') ? options.color1 : _color.COLOR.black;
      this._color2 = _utility.default.has(options, 'color2') ? options.color2 : _color.COLOR.black;
      this._color3 = _utility.default.has(options, 'color3') ? options.color3 : _color.COLOR.black;
      this._color4 = _utility.default.has(options, 'color4') ? options.color4 : _color.COLOR.black;
...
function (_BaseComponent) {
  ...
  function TextMeter(canvas, options) {
    ...
    _this = _possibleConstructorReturn(this, (TextMeter.__proto__ || Object.getPrototypeOf(TextMeter)).call(this, canvas, options, 0, 0, null, 100));
    _this._displayValue = '';
    _this._speed = 3;
    _this._lineWidth = 5;
    _this._arrowWidth = 40;
    _this._pctHeight = 30;
    _this._meterWidth = _this._width - 2 * _this._arrowWidth;
  ...
  _createClass(TextMeter, [{
    key: "setOptions",
    value: function setOptions(options) {
      this._percentageValue = _utility.default.has(options, 'percentageValue') ? options.percentageValue : 50;
      ...
      this._bgColor = _utility.default.has(options, 'bgColor') ? options.bgColor : _color.COLOR.grey;
      this._lineColor = _utility.default.has(options, 'lineColor') ? options.lineColor : _color.COLOR.black;
      this._arrowColor = _utility.default.has(options, 'arrowColor') ? options.arrowColor : _color.COLOR.black;
    }
  }, {
    ...
    value: function drawFrame() {
      ...
      var actualPctHeight = this._pctHeight - this._lineWidth / 2;
      ...
      if (this._arrow !== null) {
        var middleHeight = (100 - this._pctHeight) / 2 + this._pctHeight;
