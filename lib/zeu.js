...
function (_BaseComponent) {
  ...
  function TextMeter(canvas, options) {
    ...
    _this._leftArrowX = -5;
    _this._rightArrowX = _this._width + 5;
    return _this;
  }
  ...
  _createClass(TextMeter, [{
    ...
    value: function drawLeftArrow() {
      if (this._leftArrowX <= -3) {
        ...
        this._leftArrowX = _utility.default.getNextPos(this._leftArrowX, -3, -this._arrowSpeed);
      }
    ...
    value: function drawRightArrow() {
      if (this._rightArrowX >= this._width + 3) {
        ...
        this._rightArrowX = _utility.default.getNextPos(this._rightArrowX, this._width + 3, this._arrowSpeed);
      }
