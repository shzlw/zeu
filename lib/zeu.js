...
function (_BaseCanvas) {
  ...
  function TextMeter(baseDiv, options) {
    ...
    _this = _possibleConstructorReturn(this, (TextMeter.__proto__ || Object.getPrototypeOf(TextMeter)).call(this, baseDiv, 200, 100)); // Options

    _this._min = _utility.default.has(options, 'min') ? options.min : 0;
    _this._max = _utility.default.has(options, 'max') ? options.max : 100;
    _this._fillColor = _utility.default.has(options, 'fillColor') ? options.fillColor : _color.COLOR.red;
    _this._fontColor = _utility.default.has(options, 'fontColor') ? options.fontColor : _color.COLOR.grey;
    _this._lineColor = _utility.default.has(options, 'lineColor') ? options.lineColor : _color.COLOR.black;
    _this._lineWidth = 5;
    _this._speed = 3;
    _this._value = 50;
    _this._space = 10;
    _this._meterWidth = 200 - _this._space * 2;
    _this._meterHeight = 100 - _this._space * 2;
    _this._x = _this._meterWidth - _this._value / (_this._max - _this._min) * _this._meterWidth + _this._space;
  ...
  _createClass(TextMeter, [{
    ...
    value: function drawFrame() {
      ...
      this._ctx.closePath(); // Draw the filled part.
      ...
      */
      ...
      var pct = Math.floor(this._value / (this._max - this._min) * 100) + '%';

      this._ctx.save(); // Draw left half text
      ...
      this._ctx.save(); // Draw right half text
      ...
      this._ctx.fillRect(190 - this._x, this._space, this._x, this._meterHeight); // Calculate x.
