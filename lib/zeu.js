...
function () {
  function BaseCanvas(baseDiv) {
    ...
    this._width = 200;
    this._height = 200; // this._canvas.style.transformOrigin = '0 0'; // scale from top left
  ...
  _createClass(BaseCanvas, [{
    ...
    value: function scale() {
      ...
      var heightScale = this._canvas.height / this._height;
...
function () {
  ...
  _createClass(BlinkText, [{
    ...
    value: function blink(message) {
      ...
      if (this._blinkTimer == null) {
        this._blinkTimer = setInterval(function () {
          var currCss = _this._div.style.cssText === _this._blinkCss ? _this._defaultCss : _this._blinkCss;
...
function (_BaseCanvas) {
  ...
  function DigitalClock(baseDiv, options) {
    ...
    _this = _possibleConstructorReturn(this, (DigitalClock.__proto__ || Object.getPrototypeOf(DigitalClock)).call(this, baseDiv));
    _this._width = 380;
    _this._height = 100; // Bar width
    ...
    _this._hourOffset = _utility.default.has(options, '_hourOffset') ? options._hourOffset : 0;
    _this._timer = null;
    return _this;
  }
...
function (_BaseCanvas) {
  ...
  _createClass(VolumeMeter, [{
    ...
    value: function drawFrame() {
      ...
      this._ctx.font = '12px Arial'; // Draw max number.

      this._ctx.fillText(this._max, 0, 15); // Draw min number.


      this._ctx.fillText(this._min, 0, this._meterHeight + 15); // Draw value.
