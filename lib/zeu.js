...
function (_BaseCanvas) {
  ...
  function DoubleCircle(baseDiv, options) {
    ...
    _this._fontColor = _color.COLOR.green;
    _this._text = 'ON';
    _this._isDot = _utility.default.has(options, 'isDot') ? options.isDot : true;
    _this._dots = _utility.default.has(options, 'dots') ? options.dots : 40;
    _this._lineWidth = 10;
    return _this;
  }
    ...
    value: function drawFrame() {
      ...
      if (this._isDot) {
        ...
        for (var _i = 0; _i < this._dots; _i++) {
          var _d = Math.PI * 2 / this._dots * _i;
