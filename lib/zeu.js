...
function (_BaseCanvas) {
  ...
  function RoundGauge(baseDiv, options) {
    ...
    _this = _possibleConstructorReturn(this, (RoundGauge.__proto__ || Object.getPrototypeOf(RoundGauge)).call(this, baseDiv, 200, 200)); // 360, 180 or 270?

    _this._startValue = 0;
    _this._endValue = 270;
    _this._startDegree = 0;
    _this._endDegree = 270;
    _this._value = 100;
    _this._isHandArrow = false;
    _this._lineColor = 'grey';
    _this._handColor = 'red';
    _this._fontColor = 'black';
    ...
    _this._speed = 3;
    _this._currDegree = 0;
    _this._targetDegree = _this._value / (_this._endValue - _this._startValue) * (_this._endDegree - _this._startDegree);
    return _this;
  }
  ...
  _createClass(RoundGauge, [{
    ...
    value: function drawFrame() {
      ...
      this._ctx.stroke(); // Draw the radar wave
...
function (_BaseCanvas) {
  ...
  _createClass(StopWatch, [{
    ...
    value: function drawFrame() {
      ...
      this._lastTime = now;
      var second = Math.floor(this._elapsedTime / 1000);
      var millis = parseInt(this._elapsedTime.toString().slice(-2), 10);
