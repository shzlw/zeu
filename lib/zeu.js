...
/*#__PURE__*/
function (_BaseCanvas) {
  _inherits(TextMeter, _BaseCanvas);

  function TextMeter(baseDiv, options) {
    var _this;

    _classCallCheck(this, TextMeter);

    _this = _possibleConstructorReturn(this, (TextMeter.__proto__ || Object.getPrototypeOf(TextMeter)).call(this, baseDiv, baseDiv.clientWidth, 100)); // Options

    _this._percentageValue = _utility.default.has(options, 'percentageValue') ? options.percentageValue : 50;
    _this._fillColor = _utility.default.has(options, 'fillColor') ? options.fillColor : _color.COLOR.red;
    _this._bgColor = _utility.default.has(options, 'bgColor') ? options.bgColor : _color.COLOR.grey;
    _this._lineColor = _utility.default.has(options, 'lineColor') ? options.lineColor : _color.COLOR.black;
    _this._lineWidth = _utility.default.has(options, 'lineWidth') ? options.lineWidth : 10;
    _this._speed = 3;
    _this._space = 0;
    _this._meterWidth = _this._scaledWidth - _this._space * 2;
    _this._meterHeight = 100 - _this._space * 2;
    _this._x = _this._meterWidth - _this._percentageValue / 100 * _this._meterWidth + _this._space;
    _this._nextX = _this._x;
    _this._barX = _this._scaledWidth - _this._space - _this._x;
    return _this;
  }
  ...
  _createClass(TextMeter, [{
    ...
    value: function drawFrame() {
      ...
      var pct = this._percentageValue + '%';

      this._ctx.restore();

      this._ctx.save();

      this.scale(); // Draw left half text
      ...
      this.scale(); // Draw right half text
      ...
      this._ctx.restore(); // Calculate x and barX.


      this._x = _utility.default.getNextPos(this._x, this._nextX, this._speed);
