...
function (_BaseCanvas) {
  ...
  function Heartbeat(canvas) {
    ...
    _this = _possibleConstructorReturn(this, (Heartbeat.__proto__ || Object.getPrototypeOf(Heartbeat)).call(this, canvas, 200, 100));
    _this._vector = 1;
    _this._queue = [];
    _this._queueMaxCapacity = 50;
    _this._lastSec = 0;
    _this._lineColor = _color.COLOR.green;
    _this._fontColor = _color.COLOR.black;
