...
function () {
  function BaseCanvas(canvas) {
    ...
    this._heightScale = this._canvas.height / this._height; // Bind the drawFrame function.
...
exports.GLOBAL = exports.default = void 0;
    ...
    value: function animate() {
      ...
      if (elapsed > this._fpsInterval) {
        ...
        var _loop = function _loop(i) {
          var drawFrameObj = GLOBAL.requestAnimationFrameArray[i]; // Buy me some time.
        ...
        for (var i = 0; i < GLOBAL.requestAnimationFrameArray.length; i++) {
          _loop(i);
        }
      }
    }
...
var _global = _interopRequireDefault(__webpack_require__(/*! ./global */ "./src/global.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// Fire up window.requestAnimationFrame()
new _global.default().animate();
...
function (_BaseCanvas) {
  ...
  _createClass(VolumeMeter, [{
    ...
    value: function drawFrame() {
      ...
      this._ctx.fillStyle = this._fillColor; // Draw the filled part.
